...
const Index = () => (
  <>
    ...
    <Parallax pages={5}>
      <Hero offset={0}>
        <BigTitle>
          Hello, <br /> <span>I'm Reekendra</span>.
        </BigTitle>
        <Subtitle>
      ...
      <Contact offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="https://twitter.com/dev_reekendra">Hi</a> or find me on
            other platforms:{" "}
            <a href="https://twitter.com/dev_reekendra">Twitter</a> &{" "}
            <a href="https://twitter.com/dev_reekendra">Instagram</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2019 by devReekendra.io.{" "}
          <a href="https://github.com/Reekendra/" target="_blank">
            Github Repository
          </a>
          .
        </Footer>
